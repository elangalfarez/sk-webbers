    ...
    <footer className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-start text-blue-200">
                <MapPin className="w-4 h-4 mr-3 mt-1 flex-shrink-0 text-purple-400" />
              ...
              <div className="flex items-center text-blue-200">
                <Phone className="w-4 h-4 mr-3 flex-shrink-0 text-purple-400" />
              ...
              <div className="flex items-center text-blue-200">
                <Mail className="w-4 h-4 mr-3 flex-shrink-0 text-purple-400" />
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold text-purple-300 mb-6">Quick Links</h4>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-lg font-semibold text-purple-300 mb-6">Our Services</h4>
