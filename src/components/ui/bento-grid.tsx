...
const BentoCard = ({
  ...
  >
    ...
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
      <Icon className="h-12 w-12 origin-left transform-gpu text-gold drop-shadow-lg transition-all duration-300 ease-in-out group-hover:scale-75" />
      <h3 className="text-xl font-semibold text-white drop-shadow-lg">
        {name}
      </h3>
      <p className="max-w-lg text-white/90 drop-shadow-md text-sm">{description}</p>
    </div>
